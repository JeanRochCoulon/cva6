source -echo -verbose ../../../scripts/invia_scripts/synth/rm_flow/common_setup.tcl
source -echo -verbose ../../../scripts/invia_scripts/synth/rm_flow/dc_setup_filenames.tcl

if {[file exists scripts/dc_addon_setup.tcl]} {
  echo "Add-on setup file found in IP dir"
  source -echo scripts/dc_addon_setup.tcl
}
...
set RTL_SOURCE_FILES  "dc.tcl"      ;# Enter the list of source RTL files if reading from RTL

# The following variables are used by scripts in the rm_dc_scripts folder to direct 
# the location of the output files.

set REPORTS_DIR "reports"
set RESULTS_DIR "netlist"
